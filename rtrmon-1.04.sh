...
# RTRMON v1.04 - Asus-Merlin Router Monitor
...
calculatestats () {
  ...
  # Network - IP Addresses
    ...
    dns1ip="$($timeoutcmd$timeoutsec nvram get wan_dns | awk '{print $1}')"
    dns2ip="$($timeoutcmd$timeoutsec nvram get wan_dns | awk '{print $2}')"
...
DisplayPage2 () {
  ...
  printf '%03d.%03d.%03d.%03d'  ${olddns1ip//./ }
  echo -en " / "
  printf '%03d.%03d.%03d.%03d'  ${olddns2ip//./ }
  echo -e " ${CGreen}]${CClear}"
  preparebar 35 "|"

...
# RTRMON v0.1b4 - Asus-Merlin Router Monitor
...
MaxSpeedLAN=1000                    #Max speed of your LAN switch in Mbps (typically 1G or 2.5G)
...
TempUnits="F"                       #Temperature unit choices: (C)elcius, (F)ahrenheit or (K)elvin
# -------------------------------------------------------------------------------------------------------------------------

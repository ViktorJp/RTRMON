...
# RTRMON v1.06b1 - Asus-Merlin Router Monitor
...
DisplayPage2 () {
  ...
  if [ ! -z $oldwanip6 ]; then echo -en "${InvCyan} ${CClear} ${CCyan}WAN 0/1 I6 ${CGreen}[ ${CCyan}$oldwanip6${CClear}"; echo -e " ${CGreen}]${CClear}"; fi
  ...
  echo ""
  preparebar 35 "|"
  progressbar $oldwantxmbrate $MaxSpeedInet " Avg WAN TX" "Mbps" "Standard" $oldwantxmbratedisplay
  echo ""
  echo -e "${CGreen} ___"
  ...
  echo -e "                   ${CGreen}]${CClear}"
  if [ ! -z $oldlanip6 ]; then echo -en "${InvCyan} ${CClear} ${CCyan}BR0 LAN I6 ${CGreen}[ ${CCyan}$oldlanip6${CClear}"; echo -e " ${CGreen}]${CClear}"; fi
  preparebar 35 "|"
